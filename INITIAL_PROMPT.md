Based on the following words listed below create a learning card UI which was each catagory mentioned in starting of bulletpoints (eg: Animal, Transportation etc). This UI/UX helps in language learning via example sentense and quiz. 

Currently generate seperate translation files one for english, one for spanish, one for kannada for now, later other languages can also be added
...
Following are themes and list of words:
